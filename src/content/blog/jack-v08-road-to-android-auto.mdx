...
<ImpactGrid>
  ...
  <ImpactMetric value={1.5} suffix="B+" label="Market by 2030" comparison="Projected global market where Jack can be used — the voice-first layer every driver needs" color="purple" />
</ImpactGrid>
