...
<ImpactGrid>
  <ImpactMetric value={8} label="Versions Shipped" comparison="From a simple wake word to a full road co-pilot in 10 days" color="blue" />
  <ImpactMetric value={0} label="Screen Taps Required" comparison="Every feature — start to finish — is voice only" color="green" />
  <ImpactMetric value={100} suffix="%" label="Hands on Wheel" comparison="Jack handles the information. You handle the road." color="orange" />
  <ImpactMetric value={1.5} suffix="B+" label="Cars on the Road" comparison="Android Auto is now standard on virtually every new vehicle sold — this is the market Jack's car screen integration targets" color="purple" />
</ImpactGrid>
