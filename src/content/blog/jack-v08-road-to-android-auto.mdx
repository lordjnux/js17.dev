...
<ImpactGrid>
  ...
  <ImpactMetric value={700} prefix="$" suffix="B+" label="Market by 2030" comparison="Projected global connected car market — Jack targets the voice-first layer every driver needs" color="purple" />
</ImpactGrid>
