    ...
    <div className="container-custom py-12 md:py-16 max-w-5xl">
      ...
      <div className="rounded-xl border bg-card overflow-hidden">
        <div className="px-5 py-4 border-b">
          ...
          <p className="text-xs text-muted-foreground">{totals.videos} videos across {uniqueSlugs} articles</p>
        </div>
        {videos.length === 0 ? (
          <div className="px-5 py-8 text-center text-sm text-muted-foreground">
            No videos published yet. Use the &quot;Publish to YouTube&quot; button on any blog post.
          </div>
        ) : (
