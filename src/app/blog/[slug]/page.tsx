    ...
    <div className="container-custom py-12 md:py-16">
      <div className="flex gap-12 justify-between">
        ...
        <article className="min-w-0 flex-1 max-w-3xl">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:no-underline hover:prose-a:underline prose-code:font-mono prose-code:bg-muted prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-pre:p-0 prose-pre:bg-transparent">
            {content}
          </div>
        </article>
